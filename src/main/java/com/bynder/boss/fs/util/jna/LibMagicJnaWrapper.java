...
public class LibMagicJnaWrapper {
    ...
    public interface LibmagicDll extends Library {
        ...
        LibmagicDll BASE = (LibmagicDll)
                Native.load(LIBRARY_NAME, LibmagicDll.class);
     ...
     *
     * @throws LibMagicException   if any error occurred while
     *         initializing the libmagic.
     *
     * @see    #LibMagicJnaWrapper(int)
     * @see    #MAGIC_MIME
     */
    public LibMagicJnaWrapper() throws LibMagicException {
     ...
     *         initializing the libmagic.
     */
    public LibMagicJnaWrapper(int flag) throws LibMagicException {
        this.cookie = LibmagicDll.INSTANCE.magic_open(flag);
        if (this.cookie == null) {
            throw new LibMagicException("Libmagic initialization failed");
        }
    }
    ...
    public String getMimeType(InputStream stream, int bufferSize) throws IOException {
